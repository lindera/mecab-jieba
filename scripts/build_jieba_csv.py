...
Usage:
    python scripts/build_jieba_csv.py [--output FILE]
...
def main() -> None:
    ...
    if args.jieba_file:
        ...
        jieba_path = os.path.join(work_dir, "dict.txt.big")
    ...
    if args.cedict_file:
        ...
        cedict_path = os.path.join(work_dir, "cedict_1_0_ts_utf-8_mdbg.txt.gz")
